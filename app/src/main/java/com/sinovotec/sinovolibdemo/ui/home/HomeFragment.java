...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        btn_chkpw.setOnClickListener(view -> {
            ...
            SinovoBle.getInstance().getLockInfo("01");
            SinovoBle.getInstance().getLockInfo("02");
            SinovoBle.getInstance().getLockInfo("03");
            SinovoBle.getInstance().getLockInfo("04");
            SinovoBle.getInstance().getLockInfo("05");
            SinovoBle.getInstance().getLockInfo("06");
            SinovoBle.getInstance().getLockInfo("07");
            SinovoBle.getInstance().getLockInfo("08");
            SinovoBle.getInstance().getLockInfo("09");
            SinovoBle.getInstance().getLockInfo("10");
