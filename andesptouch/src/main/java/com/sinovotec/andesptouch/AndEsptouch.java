package com.sinovotec.andesptouch;
...
//    private static AndEsptouch instance;
//
//    public static AndEsptouch getInstance(Context mContext) {
//        if (instance == null) {
//            synchronized (AndEsptouch.class) {      //同步锁,一个线程访问一个对象中的synchronized(this)同步代码块时，其他试图访问该对象的线程将被阻塞
//                if (instance == null) {
//                    instance = new AndEsptouch(mContext);
//                }
//            }
//        }
//        return instance;
//    }
    ...
    public static class Builder {
        ...
        private final AndEsptouch andEsptouch;
    ...
    public void startConfig() {
       ...
       // mEsptouchAsyncTask.execute(ssid, bssid, password, count);
        ...
        //并行执行，立马执行
        mEsptouchAsyncTask.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR,ssid, bssid, password, count);
        Log.d(TAG, "执行完成配置任务");
    ...
    public void cancelAsyncTask (){
        if (mEsptouchAsyncTask != null) {
            mEsptouchAsyncTask.cancel(true);
        }
    }
